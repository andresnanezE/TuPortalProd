...
{
    public class ServicioAplicacionReporteSabanaAsesores : IServicioAplicacionReporteSabanaAsesores
    {
        #region Readonly & Static Fields

        private readonly IAdaptadorDeObjetos _adaptadorDeObjetos;
        private readonly IRepositorioLogs _manejadorLogs;
        private readonly IRepositorioReporteSabanaAsesores _repositorioAfiliaciones;

        #endregion Readonly & Static Fields

        #region C'tors

        public ServicioAplicacionReporteSabanaAsesores(IRepositorioReporteSabanaAsesores repositorioAfiliaciones, IRepositorioLogs manejadorLogs, IAdaptadorDeObjetos adaptadorDeObjetos)
        {
        ...
        public ConsultaDobleDto Consultar_Detalle_Afiliacion_Resumen(DatosConsultaAfiliacionDto datos)
        {
            try
            {
                DatosConsultaAfiliacion datosEntidad = new DatosConsultaAfiliacion()
                {
                ...
                var listaDobleDto = _adaptadorDeObjetos.Adaptar<ConsultaDobleDto>(lista);
                return listaDobleDto;
            }
            catch (SystemException exception)
            {
