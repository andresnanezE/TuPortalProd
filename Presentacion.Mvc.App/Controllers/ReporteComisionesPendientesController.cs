...
{
    public class ReporteComisionesPendientesController : Controller
    {
        ...
        // GET: ReporteComisionesPendientes
        public ActionResult Index()
        {
            var model = new ComisionesPendientesModel();
            ...
            model.CentrosCosto = ServicioAplicacionAfiliaciones.ObtenerCentrosCosto();
            model.Escaleras = ServicioAplicacionAfiliaciones.ObtenerEscaleras();
        ...
        [HttpPost]
        public JsonResult GenerarReporte(ComisionesPendientesModel model)
        {
            ...
            try
            {
                ...
                nonbrerte = "ReporteComisionesPendientes - " + DateTime.Now.ToShortDateString() + ".xls";
