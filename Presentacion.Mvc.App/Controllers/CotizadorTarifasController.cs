...
namespace Presentacion.Mvc.App.Controllers
{
    public class CotizadorTarifasController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var oUsuarioCiudad = ServicioAplicacionCotizadorTarifas.getUsuarioCiudad(sUsuario);
            model.UsuarioCiudad = oUsuarioCiudad;
            model.TiposTarifas = ServicioAplicacionCotizadorTarifas.getTiposTarifas();

            foreach (var tipoTarifa in model.TiposTarifas)
            {
                tipoTarifa.CAMPANAS = ServicioAplicacionCotizadorTarifas.getCampanas(tipoTarifa.CODIGO_TARIFA);
            }
        ...
        public String Json(String sCiudad, int iPersonas, String sTipoTarifa, String sCampana)
        {
            ...
            var ieTarifas = ServicioAplicacionCotizadorTarifas.getTarifasBase(sCiudad, iPersonas, sTipoTarifa, sCampana, sUsuario);
