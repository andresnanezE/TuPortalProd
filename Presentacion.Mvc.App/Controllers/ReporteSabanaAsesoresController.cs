...
#pragma warning disable CS0169 // The field 'ReporteSabanaAsesoresController._servicioAplicacionTablaBase' is never used
        private IServicioAplicacionTablasBase _servicioAplicacionTablaBase;
#pragma warning restore CS0169 // The field 'ReporteSabanaAsesoresController._servicioAplicacionTablaBase' is never used
                    ...
                    _modelRequest.ListaResultadoResumenTabla =
                        ServicioAplicacionAfiliaciones.Consultar_Detalle_Afiliacion_ResumenTabla(new DatosConsultaAfiliacionDto()
                        {
                            ...
                            Comisiona = _modelRequest.ListaFiltros.FirstOrDefault(x => x.DatosFiltro.ID_CODIGO.Equals("Comisiona")).Mostar.Equals("N") ? _modelRequest.ListaFiltros.FirstOrDefault
                                                                                                        (x => x.DatosFiltro.ID_CODIGO.Equals("Comisiona")).FiltroDefault.Split(',').ToList() : _modelRequest.Comisiona,
                            EstBenef = _modelRequest.ListaFiltros.FirstOrDefault
                                                                                                        (x => x.DatosFiltro.ID_CODIGO.Equals("EstBenef")).Mostar.Equals("N") ? _modelRequest.ListaFiltros.FirstOrDefault
                                                                                                        (x => x.DatosFiltro.ID_CODIGO.Equals("EstBenef")).FiltroDefault.Split(',').ToList() : _modelRequest.EstBenef,
                            TipContrato = _modelRequest.ListaFiltros.FirstOrDefault
                                                                                                        (x => x.DatosFiltro.ID_CODIGO.Equals("TipContrato")).Mostar.Equals("N") ? _modelRequest.ListaFiltros.FirstOrDefault
                                                                                                        (x => x.DatosFiltro.ID_CODIGO.Equals("TipContrato")).FiltroDefault.Split(',').ToList() : _modelRequest.TipContrato,
                            Novedad = _modelRequest.ListaFiltros.FirstOrDefault
