function IndexViewModel() {
    ...
    self.loadFile = function () {
        ...
        if (self.noFormulario() === "" || self.noFormulario() === undefined) {
            $('#noFormulario').addClass('rqr-1');
        }
        else if (self.noFormulario() <= 0) {
            $('#noFormulario').addClass('rqr-1');
            self.noFormulario('Ingrese un número válido');
        }
        ...
        if (self.noAfiliados() === "" || self.noAfiliados() === undefined) {
            $('#noAfiliados').addClass('rqr-3');
        }
        else if (self.noAfiliados() <= 0) {
            $('#noAfiliados').addClass('rqr-3');
            self.cedRequired('Ingrese un número válido');
        }
        else
        ...
        if (self.noFormulario() !== "0" && self.noFormulario() !== 0 && self.noFormulario().length < 4 && self.cedAsesor() && self.cedContratante() &&
            self.cedContratante().length >= 5 && self.noAfiliados() !== "0" && self.noAfiliados() !== 0
    ...
    self.EditFile = function () {
        ...
        if (
            self.noFormularioEdit() !== "" && self.noFormularioEdit() !== 0 && self.noFormularioEdit() !== undefined && !(self.noFormularioEdit().length < 3)
            ...
            && self.noAfiliadosEdit() !== "" && self.noAfiliadosEdit() !== undefined & self.noAfiliadosEdit() !== 0
...
function validateNumber(id, idalert, isquery) {
    ...
    if (id == 0 || id == "") {
        $("#" + idalert).text('Debe ser un número valido y diferente de cero');
