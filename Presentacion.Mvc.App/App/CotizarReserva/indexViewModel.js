(function () {
    ...
    angular.module('portalComercialApp', ['angular-loading-bar', 'cfp.loadingBar']).controller('CotizarReservaController', CotizarReservaController);

    function CotizarReservaController($scope, $http, $window) {
        ...
        $scope.getObtenerListados = function (nombreListado) {
            ...
            $http({
                url: '../CotizarReserva/ObtenerListados/',
                method: "GET",
        ...
        $scope.getObtenerIdCotizacion = function () {
            $http({
                url: '../CotizarReserva/ObtenerIdCotizacion/',
                method: "GET"
            }).then(function (res) {
        ...
        $scope.getObtenerInformacionReserva = function () {
            $http({
                url: '../CotizarReserva/ObtenerInformacionReserva/',
                method: "GET"
            }).then(function (res) {
        ...
        $scope.getObtenerNombreDirector = function () {
            $http({
                url: '../CotizarReserva/ObtenerNombreDirector/',
                method: "GET"
            }).then(function (res) {
        ...
        $scope.getObtenerInfReporteCotizacion = function () {
            $http({
                url: '../CotizarReserva/ObtenerInfReporteCotizacion/',
                method: "GET"
            }).then(function (res) {
        ...
        $scope.getObtenerInfSedesCotizacion = function () {
            $http({
                url: '../CotizarReserva/ObtenerInfSedesCotizacion/',
                method: "GET"
            }).then(function (res) {
        ...
        $scope.guardarCotizacion = function () {
            ...
            $("#btnGuardarInfo").attr("disabled", true);
            ...
            window.setTimeout(function () {
                ...
                $http({
                    url: "../CotizarReserva/GuardarCotizacion/"
                    , dataType: 'json'
                    , method: "POST"
                ...
                function successHandler(res) {
                    ...
                    if (res.data !== null) {
                        ...
                        if (res.data.RespCotizacion === true && res.data.RespCotizacionSedes === true) {
                            ...
                            //Respuesta de Divisor
                            if (res.data.RespCotizacionDivisor === true) {
                                $scope.motrarAlerta(1, res.data.MensajeCotizacionDivisor);
                            }
                            else {
                                $scope.motrarReporte = false;
                                $("#modalResumenCotizacion").modal("hide");
                                $scope.motrarAlerta(2, res.data.MensajeCotizacionDivisor);
                            }
                        }
                    }
                }
        ...
        $scope.generarPdf = function (inf) {
            ...
            kendo.drawing.drawDOM($(inf.sectionExportar), {
                ...
                margin: { left: "0cm", top: "4.2cm", right: "0cm", bottom: "4.8cm" },
        ...
        $scope.enviarEmailCotizacion = function () {
            $http({
                url: "../CotizarReserva/EnviarEmailCotizacion/"
                , dataType: 'json'
                , method: "POST"
