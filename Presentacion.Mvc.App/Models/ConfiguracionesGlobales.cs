...
namespace Presentacion.Mvc.App.Models
{
    public static class ConfiguracionesGlobales
    {
        ...
        public static string ArchivoClausulado
        {
            get { return ConfigurationManager.AppSettings["Archivos:ArchivoClausulado"]; }
        }

        public static string ManualUsuario
        {
            get { return ConfigurationManager.AppSettings["Archivos:ManualUsuario"]; }
        }
        ...
        public static string ReportPathReporteCertificadoAfiliacion
        {
            get { return ConfigurationManager.AppSettings["REPORTES:ReportPathReporteCertificadoAfiliacion"]; }
        }

        public static string ReportPathCertificadoTributario
        {
            get { return ConfigurationManager.AppSettings["REPORTES:ReportPathCertificadoTributario"]; }
        }

        public static string ReportPathReporteEstadoCuenta
        {
            get { return ConfigurationManager.AppSettings["REPORTES:ReportPathReporteEstadoCuenta"]; }
        }

        public static string ReportPathReporteCarnet
        {
            get { return ConfigurationManager.AppSettings["REPORTES:ReportPatHReporteCarnet"]; }
        }

        public static string ReportPthReporteCotizacionesAsesor
        {
            get { return ConfigurationManager.AppSettings["REPORTES:ReportPathReporteCotizacionReservaAsesorXDirector"]; }
        }

        public static string ReportPathESuscription
        {
            get { return ConfigurationManager.AppSettings["REPORTES:ReportPathESuscription"]; }
        }
        public static string ApiTokenFacturacion
        {
            get { return ConfigurationManager.AppSettings["ApiTokenFacturacion"]; }
        }
        public static string ApiUrlFacturacion
        {
            get { return ConfigurationManager.AppSettings["ApiUrlFacturacion"]; }
        }
