...
namespace Presentacion.Mvc.App.Models
{
    ...
    {
        List<CiudadUsuario> _ciudad = new List<Models.CiudadUsuario>();
        List<CanalUsuario> _canal = new List<Models.CanalUsuario>();
        List<SegmentoUsuario> _segmento = new List<Models.SegmentoUsuario>();
        List<PerfilUsuario> _perfil = new List<Models.PerfilUsuario>();
