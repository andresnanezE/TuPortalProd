 ...
 * http://filer.grandesign.md/old_version
...
(function ($) {
                            ...
                            if (n.changeInput) {
                                switch (typeof n.changeInput) {
                                    case "boolean":
                                        ...
                                        o = $('<div class="glyphicon glyphicon-paperclip btn btn-primary"></div>');
                                        break;
                                    case "string":
                                    case "object":
                                        o = $(n.changeInput);
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            button: "Seleccione los archivos",
            feedback: "Archivos",
            feedback2: "Los archivos fueron seleccionados",
            drop: "Elimine los archivos seleccionados",
            removeConfirmation: "Esta seguro que desea descartar este archivo?",
            errors: {
                filesLimit: "Solo {{fi-limit}} archivos son permitidos.",
                filesType: "Este tipo de archivo no esta permitido.",
                filesSize: "{{fi-name}} es muy grande! Por favor seleccione un archivo menor de {{fi-maxSize}} MB.",
                filesSizeAll: "Los archivos que ud ha seleccionado son demasiado grandes! Por favor seleccione archivos de {{fi-maxSize}} MB.",
                folderUpload: "No se le permite subir carpetas."
            }
        }
    }
})(jQuery);
