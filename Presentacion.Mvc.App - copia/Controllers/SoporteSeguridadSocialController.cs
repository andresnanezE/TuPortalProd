...
namespace Presentacion.Mvc.App.Controllers
{
    public class SoporteSeguridadSocialController : Controller
    {
        ...
        readonly string MENSAJE = "Hay un problema enviando el mensaje.";
        readonly string MENSAJEENVIADO = "Mensaje enviado.";
        readonly string MENSAJEGENERAL = "Intentalo nuevamente, si el problema persiste comunicate con el árear de tecnología.";
        readonly string ERROEGETMOTIVOS = "Error consultando la lista de motivos.";
