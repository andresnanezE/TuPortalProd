...
namespace Presentacion.Mvc.App.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult Index(UsuarioModel model)
        {
            ...
            {
                model.TipoDocumentos = ServicioAplicacionTablasBase.ObtenerTipoDocumentos();
                model.ListaUsuarios = ServicioAplicacionUsuarios.ObtenerUsuarioFiltros(model.UsuarioFiltro, model.NombreUsuarioFiltro, model.TipoDocumento, model.DocumentoFiltro, model.CorreoFiltro).ToPagedList(1, 20);
